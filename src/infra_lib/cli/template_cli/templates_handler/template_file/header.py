...
class DefaultHeaderGenerator(HeaderGenerator):
	...
	def __init__(self, generator_name: str = "infra_lib", generator_version: str = "0.0.1"):
	...
	def generate_header(self, target_path: Path) -> str:
		...
		header_text = (
			f"Autogenerated by {self.generator_name} {self.generator_version} on {timestamp} UTC.\n"
		)
